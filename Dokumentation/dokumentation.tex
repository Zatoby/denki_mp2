...
\section*{Umsetzung}
Die chart.js Bibliothek hat das grobe Gerüst unseres Projekts dargestellt. Wir mussten rundherum etwas erschaffen, das eine benutzerfreundliche Interaktion mit den Graphen ermöglicht.
...
Die Kernfunktionen waren schnell erstellt. Damit die Seite auch ansprechend ausschaut, musste sie allerdings auch gestylt werden. Dazu haben wir \textbf{Tailwindcss} genutzt.
Tailwind ist ein CSS Framework, das das Stylen von Websites durch vordefinierte Klassen weitaus einfacher gestaltet.


\section*{Feedback}
\subsection*{BOKU Studentin}
\textbf{Wofür könnte man das Tool einsetzen?}
Um Graphen so zu zeigen/manipulieren, dass sie die eigene Meinung vertreten.
\\\\
...
\subsection*{Studienkollegin}
\textbf{Wofür könnte man das Tool einsetzen?}
Für Bildungszwecke.
\\\\
\textbf{Hast du dich zurechtgefunden?}
Ja, nach ein bissl Herumprobieren.
\\\\
\textbf{Ist das Design ansprechend?/passend}
Unterschied zwischen Bubble und Scatter nicht gecheckt, sonst aber ja.
\\\\
\textbf{Welche Features fehlen dir?}
Ein integriertes Tutorial.
\\\\
\textbf{Willst du uns sonst noch etwas mitteilen?}
Es hat einen wirklich guten Zusammenhang zu den Denkweisen.

\subsection*{Limitationen des Feedbacks}
Dadurch, dass wir nur Personen in unserem näheren Umfeld befragt haben, ist das Feedback natürlich ein wenig verzerrt. Zudem sind zwei der drei Befragten im technischen Bereich tätig, und kennen sich dadurch wahrscheinlich besser mit der Bedienung von einer derartigen Benutzeroberfläche aus. Wirklich spannend wäre es also eigentlich noch gewesen, sich das Feedback von jemandem anzuhören, der mit dieser Materie gar nicht vertraut ist.
